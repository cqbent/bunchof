						...
						<div class="control-group">
							<div class="controls">
								<input type="text" class="input-large" name="machine_token">
									Get a new machine token <a href="https://dashboard.pantheon.io:443/machine-token/create?client=blogvault&device=blogvault_migration_for_sitename_xyz" target="_blank">here.</a>
