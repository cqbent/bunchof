...
class easy_nag_popup {
        ...
        function meta_info() {
                ...
                $hours_between_display  = get_post_meta($post->ID, 'hours_between_display', true);
                ...
                if (!is_numeric($hours_between_display) || $hours_between_display > 50 || $hours_between_display < 0){
                        $hours_between_display = 24;
                }
                ...
                <div class="popup" id="popup-wrap">
                        ...
                        <div class="plugin-settings">
                                ...
                                <label for="hours_between_display">Hours Between Displaying Modal</label><input type="text" value="<?php echo $hours_between_display;?>" id="hours_between_display" name="hours_between_display" /><div class="clearboth"></div>
        ...
        function save_meta($post_id, $post) {
            ...
            if ( empty($_POST) || !wp_verify_nonce($_POST['update-popup'],'update-popup') ){
              return;
                ...
                $meta['hours_between_display']      = $_POST['hours_between_display'];
        ...
        function site_enqueues(){
                ...
                $hours_between_display = get_post_meta($popup_post_id, 'hours_between_display', true);
                ...
                $image = $image_array[0];
                $cookie_views_val = $_COOKIE["popup_cookie_views_" . $popup_post_id];
                $cookie_time_val = $_COOKIE["popup_cookie_time_" . $popup_post_id];
                $current_time = time();
                $cookie_limit =  get_post_meta($popup_post_id, 'number_views', true);
                if (is_numeric($popup_post_id) && $popup_post_id) $popup_exists = true;
                if ($number_views == 0 || !(is_numeric($cookie_views_val) && $cookie_views_val>=$cookie_limit) && ($current_time > $cookie_time_val)) $show_popup = true;
                if ($popup_exists && $show_popup){
                        ...
                        $pass_array           = array(
                                              ...
                                              "hours_between_display"   => $hours_between_display,     
