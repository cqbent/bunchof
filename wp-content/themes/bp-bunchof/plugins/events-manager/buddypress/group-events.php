...
/* WARNING! This file may change in the near future as we intend to add features to BuddyPress - 2012-02-14 */
	...
	?>
		...
		<ul>
			<li class="current selected"><a href="#" title="Group Events">Our Group Events</a></li>
			
			<li><a href="<?php bp_loggedinuser_link() ?>events/my-events/edit/?action=edit" title="New Event">Create a new event</a></li>
		</ul>
	</div>
	...
	<?php
        if (!bp_group_is_member()) {
            echo "<p>".__('You must be a member of this group to view events.','dbem')."</p>";
        }
	elseif (empty ( $EM_Events )) {
		// TODO localize
						...
						*/ ?>
						...
						<td>
							...
							<?php
                                                            ...
                                                            $event_time_start = date('g:i a', $event->start);
                                                            $event_time_end = date('g:i a', $event->end);
