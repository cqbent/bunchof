	...
	<div class="wrap">
		...
		<div class="inside event-form-details">
			...
			<div class="event-extra-details">
                            <p>
                                ...
                                Equipment Needed:<br>
                                <i>List any tools and equipment you're hoping to borrow from group members to complete this project<br>
                                Still need stuff?  <a href="/bunchof/purchase-products">Check out our equipment resources</a>.</i>
                            </p>
                            <p>
                                Expertise Needed:<br>
                                <i>Solicit any helpful skills that will make this project run more smoothly (i.e. growing grass experience,<br>landscape design, managing bugs and critters, etc.)<br>
                                Need a pro?  <a href="/bunchof/hire-help">Check out our experts </a></i>
                            </p>
		...
		<div class="inside event-form-image">
			<?php em_locate_template('forms/event/featured-image-public.php',true); ?>
                    <p><em>Image will appear after submitting event</em></p>
		</div>
		<?php endif; ?>
