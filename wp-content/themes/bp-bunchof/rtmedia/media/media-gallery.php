<div class="rtmedia-container">
    ...
    <?php
     ...
     <?php 
    $friend_status = friends_check_friendship( bp_loggedin_user_id(), bp_displayed_user_id());

     ?>
    <?php if ( have_rtmedia () && ($friend_status || bp_is_my_profile() || bp_group_is_member()) ) { ?> 
...
<!--            <a id="rtMedia-galary-prev" <?php //echo $display; ?> href="<?php //echo rtmedia_pagination_prev_link (); ?>"><?php //_e( 'Prev', 'rtmedia' ); ?></a>-->
    ...
    <?php 
    }  elseif (!$friend_status && !bp_is_my_profile() && !bp_group_is_member()) {
            print '<p class="rtmedia-no-media-found">
                You must be a friend to view this member\'s media. 
                </p>
            ';
    ?>
