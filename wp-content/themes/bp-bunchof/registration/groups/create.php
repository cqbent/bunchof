		...
		<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
			...
			<div class="item-body" id="group-create-body">
				...
				<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
					<div style="width:70%;">
						<h4>For new groups</h4>
					<p>
					You are about to form a GROUP to work on many different projects at each others' homes and/or at other locations. Please title and be <u>very descriptive</u>.  This information will be viewable on the public "Groups" page and any part of it may be used as a search term by other BunchOf Gardeners members.
					</p>
					<p><strong>Include location information!</strong><br> Include city, town, and/or zip code so local members can find and join your group.  Include any location information if on public grounds (i.e. the name of field, square, school, with city/town/zip). 
					</p>
					<p>Once the group is formed, members may be invited, projects scheduled, plus much more!
					</p>
					</div>
				...
				<?php if ( bp_is_group_creation_step( 'group-settings' ) ) : ?>
					...
					<div class="radio">
						<label>
							...
							<p style="padding-bottom:10px; width:60%;">Any member who joins the group is able to invite other users to this group.</p>
						<label>
							<input type="radio" name="group-invite-status" value="mods"<?php bp_group_show_invite_status_setting( 'mods' ); ?> />
							<strong><?php _e( 'Group admins and mods only', 'buddypress' ); ?></strong>
						
  						</label>
							<p style="padding-bottom:10px;width:60%;">The group admin (you) and whoever you choose to have administrative power in this group (I.E., edit group info, add, delete members, etc.), as well
							as moderators (have access to moderate forums and certain group info.) may invite users to this group.</p>
						...
						<p style="padding-bottom:10px;width:60%;">Only you, and others you choose as administrators can invite users to this group.</p>
					</div>
