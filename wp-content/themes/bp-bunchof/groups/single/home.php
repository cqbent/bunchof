		...
		<div class="padder">
			...
			<div id="item-body">
				...
				if ( bp_group_is_visible() ) :
					...
					if ( bp_is_group_home() ) :
						...
						// Default to activity
                                                // SYP: if user is not member of this group then cannot see activity
						elseif ( bp_is_active( 'activity' ) &&  bp_group_is_member()  ) : locate_template( array( 'groups/single/activity.php' ), true );
			...
			<?php endwhile; endif; ?>
                    ...
                    <?php
                        ...
                        ?>
                        <div class="message">You must be logged into view individual group profiles</div>
                        <?php
                    }
